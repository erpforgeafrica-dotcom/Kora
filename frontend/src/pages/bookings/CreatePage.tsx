...
export default function CreateBookingsPage() {
  ...
  const { create } = useCrud<Booking>("/api/bookings");
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<Booking>();
  ...
  return (
    <PageLayout title="New Booking">
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl">
        <FormSection title="Booking Details" description="Schedule a new appointment">
